...
public class RuleTest {
    ...
    public void test() {
        ...
        try {
            ...
            measurementUnit.getMeasurements().add(new Measurement("color", "yellow"));
            measurementUnit.getMeasurements().add(new Measurement("color", "brown"));
            ...
            assertTrue("contains yellow", measurementUnit.getControlSet().contains("yellow"));
            assertTrue("contains brown", measurementUnit.getControlSet().contains("brown"));
        } finally {
            instance.close();
        }
    }
